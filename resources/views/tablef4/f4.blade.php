        ...
        <div class="col-xl-12 table-responsive p-0">
            <table id="zero_config" class="table table-striped table-bordered">
                ...
                <tbody class="bg-white">
                    @if(count($tablef4s) > 0)
                        @foreach($tablef4s as $key=>$tablef4)
                            <tr>
                                <td>{{$key + 1}}</td>
                                <td>{{$tablef4->Кодструктуры}}</td>
                                <td>{{$tablef4->КодПЗ1_1}}</td>
                                <td>{{$tablef4->КодПЗ1_2}}</td>
                                <td>{{$tablef4->КодПЗ1_3}}</td>
                                <td>{{$tablef4->ОценкаСвязиПЗ1}}</td>
                                <td>{{$tablef4->ТипСвязиПЗ1}}</td>
                                <td>{{$tablef4->КодСвязиПЗ1}}</td>
                                <td>
