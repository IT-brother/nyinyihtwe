        ...
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-0 pt-0">
                        <label for="username" class="col-form-label pt-0">Username<b class="text-danger">*</b></label>
                        <input type="text" class="form-control" autocomplete="off" style="background:#eee" name="username" id="username" required />
                    </div>
                    <div class="form-group mt-0 pt-0">
                    ...
                    <div class="form-group mt-0 pt-0 row">
                        ...
                        <!-- <div class="col-md-4">
                            <input type="radio" value="3" name="role" id="superadmin" required>
                            <label for="superadmin" class="col-form-label">Super Admin </label>
                        </div> -->
                        <div class="col-md-6">
                            <input type="radio" value="2" name="role" id="moderator" required>
